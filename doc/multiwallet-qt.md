...
In order to support loading of multiple wallets in umbra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is umbra.cpp.
...
Changes to umbra.cpp
----------------------
umbra.cpp is the entry point into umbra-qt, and as such, will require some minor modifications to provide hooks for

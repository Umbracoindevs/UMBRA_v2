...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Umbra features */
        {"umbra", "masternode", &masternode, true, true, false},
        {"umbra", "listmasternodes", &listmasternodes, true, true, false},
        {"umbra", "getmasternodecount", &getmasternodecount, true, true, false},
        {"umbra", "masternodeconnect", &masternodeconnect, true, true, false},
        {"umbra", "masternodecurrent", &masternodecurrent, true, true, false},
        {"umbra", "masternodedebug", &masternodedebug, true, true, false},
        {"umbra", "startmasternode", &startmasternode, true, true, false},
        {"umbra", "createmasternodekey", &createmasternodekey, true, true, false},
        {"umbra", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"umbra", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"umbra", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"umbra", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"umbra", "getmasternodescores", &getmasternodescores, true, true, false},
        {"umbra", "mnbudget", &mnbudget, true, true, false},
        {"umbra", "preparebudget", &preparebudget, true, true, false},
        {"umbra", "submitbudget", &submitbudget, true, true, false},
        {"umbra", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"umbra", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"umbra", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"umbra", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"umbra", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"umbra", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"umbra", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"umbra", "checkbudgets", &checkbudgets, true, true, false},
        {"umbra", "mnsync", &mnsync, true, true, false},
        {"umbra", "spork", &spork, true, true, false},
        {"umbra", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"umbra", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use umbrad, or the -server option to umbra-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> umbra-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:88877/\n";
}

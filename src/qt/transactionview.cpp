                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Umbra from zUmbra"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zUmbra"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zUmbra));

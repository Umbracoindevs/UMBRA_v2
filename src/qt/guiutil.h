...
/** Utility functions used by the Umbra Qt UI.
 */
namespace GUIUtil
{
...
// Render Umbra addresses in monospace font
...
// Parse "umbra:" URI into recipient object, return true on successful parsing

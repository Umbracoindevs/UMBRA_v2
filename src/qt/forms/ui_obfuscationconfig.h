...
public:
    ...
    void retranslateUi(QDialog *ObfuscationConfig)
    {
        ...
        label_2->setText(QApplication::translate("ObfuscationConfig", "Use 2 separate masternodes to mix funds up to 10000 UMB", Q_NULLPTR));
        label_3->setText(QApplication::translate("ObfuscationConfig", "Use 8 separate masternodes to mix funds up to 10000 UMB", Q_NULLPTR));
        label_4->setText(QApplication::translate("ObfuscationConfig", "Use 16 separate masternodes", Q_NULLPTR));
        label_6->setText(QApplication::translate("ObfuscationConfig", "This option is the quickest and will cost about ~0.025 UMB to anonymize 10000 UMB", Q_NULLPTR));
        label_7->setText(QApplication::translate("ObfuscationConfig", "This option is moderately fast and will cost about 0.05 UMB to anonymize 10000 UMB", Q_NULLPTR));
        ...
        label_9->setText(QApplication::translate("ObfuscationConfig", "0.1 UMB per 10000 UMB you anonymize.", Q_NULLPTR));
    } // retranslateUi

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Umbra Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Umbra address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and umbra: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zUMB"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Umbra Core"), this);
    aboutAction->setStatusTip(tr("Show information about Umbra Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Umbra"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Umbra addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Umbra addresses"));
    ...
    openAction->setStatusTip(tr("Open a Umbra: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Umbra Core help message to get a list with possible Umbra command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Umbra Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Umbra network", "", count));
}
...
{
    QString strTitle = tr("Umbra Core"); // default title
...
/** Creates context menu, its actions, and umbras up all the relevant signals for mouse events. */

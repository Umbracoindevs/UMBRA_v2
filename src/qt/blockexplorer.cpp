...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::UMB, nValue);
...
{
    std::string genesisblockhash = "00000b9d3686f1e4ce746190ad8f20a0d3c6de654d9696522eddaec147ceba44";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (umbra.conf).");
            QMessageBox::warning(this, "Umbra Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#ffffff; bgcolor:#e7240f;}\n a, span { font-family: monospace; }\n span.addr {color:#e7240f; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #e7240f;}\n td.d0 {font-weight: bold; color:#ffffff;}\n h2, h3 { white-space:nowrap; color:#e7240f;}\n a { color:#000000; text-decoration:none; }\n a.nav {color:#e7240f;}\n";

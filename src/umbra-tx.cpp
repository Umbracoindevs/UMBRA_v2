...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Umbra Core umbra-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  umbra-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded umbra transaction") + "\n" +
                               "  umbra-tx [options] -create [commands]   " + _("Create hex-encoded umbra transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded umbra transaction

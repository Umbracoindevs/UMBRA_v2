...
The Umbra Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Umbra Core project, and is not to be
confused with overall Umbra Network Protocol consensus changes.

Whether a pull request is merged into Umbra Core rests with the project merge
...
Patches that change Umbra consensus rules are considerably more involved than
...
Where a patch set proposes to change the Umbra consensus, it must have been
...
The project leader is the release manager for each Umbra Core release.
